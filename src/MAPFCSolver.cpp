...
MAPFCSolver::MAPFCSolver(const Graph& graph, const ConflictAnnotation& annotation)
    : graph(graph), annotation(annotation) {}

DiscreteSchedule MAPFCSolver::solve(){
...
std::vector<State> MAPFCSolver::getStartStates(){
