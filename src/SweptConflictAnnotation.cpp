...
SweptConflictAnnotation::SweptConflictAnnotation(const Graph& graph, const RobotModel& robotModel) 
...
Eigen::Vector3d SweptConflictAnnotation::segment_to_point(const Eigen::Vector3d& a, 
...
std::tuple<Eigen::Vector3d, Eigen::Vector3d> SweptConflictAnnotation::segment_to_segment(const Eigen::Vector3d& p1, 
...
std::map<int, std::set<int>> SweptConflictAnnotation::findConEV(){
...
std::map<int, std::set<int>> SweptConflictAnnotation::findConEE(){
